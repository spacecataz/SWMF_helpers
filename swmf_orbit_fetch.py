...
parser.add_argument('--info', '-i', action='store_true',
                    help='Print available satellites and exit.')
...
def plot_orbits(orbits, lim=[-20, 20], coord='GSM'):
    ...
    for s in orbits:
        # Add lines:
        line = a1.plot(s['xyz'][0, :], s['xyz'][1, :])[0]
        line = a2.plot(s['xyz'][0, :], s['xyz'][2, :])[0]
        lines.append(line)
        labels.append(s.attrs['file'][:-4])

        # Annotate:
        for i in (0, -1):
            a1.plot(s['xyz'][0, i], s['xyz'][1, i], 'o', c=line.get_c())
            a1.annotate(f"{s['time'][i]:%Y-%m-%dT%H:%M}",
                        [s['xyz'][0, i], s['xyz'][1, i]],
                        c=line.get_c(), size=8)
            a2.plot(s['xyz'][0, i], s['xyz'][2, i], 'o', c=line.get_c())
...
sats = {
    'cluster1': {'set': 'C1_CP_FGM_SPIN',
                 'var': 'sc_pos_xyz_gse__C1_CP_FGM_SPIN',
                 'time': 'time_tags__C1_CP_FGM_SPIN',
                 'coord': 'GSE',
                 'units': 'km'},
    'cluster2': {'set': 'C2_CP_FGM_SPIN',
                 'var': 'sc_pos_xyz_gse__C2_CP_FGM_SPIN',
                 'time': 'time_tags__C2_CP_FGM_SPIN',
                 'coord': 'GSE',
                 'units': 'km'},
    'cluster3': {'set': 'C3_CP_FGM_SPIN',
                 'var': 'sc_pos_xyz_gse__C3_CP_FGM_SPIN',
                 'time': 'time_tags__C3_CP_FGM_SPIN',
                 'coord': 'GSE',
                 'units': 'km'},
    'cluster4': {'set': 'C4_CP_FGM_SPIN',
                 'var': 'sc_pos_xyz_gse__C4_CP_FGM_SPIN',
                 'time': 'time_tags__C4_CP_FGM_SPIN',
                 'coord': 'GSE',
                 'units': 'km'},
    'goes06': {'set': 'G6_K0_EPS',
               'var': 'SC_pos_sm',
               'time': 'Epoch',
               'coord': 'GSM',
               'units': 'km'},
    'goes07': {'set': 'G7_K0_EPS',
               'var': 'SC_pos_sm',
               'time': 'Epoch',
               'coord': 'GSM',
               'units': 'km'},
    'goes08': {'set': 'G8_K0_EP8',
               'var': 'SC_pos_sm',
               'time': 'Epoch',
               'coord': 'GSM',
               'units': 'km'},
    'goes09': {'set': 'G9_K0_EP8',
               'var': 'SC_pos_sm',
               'time': 'Epoch',
               'coord': 'GSM',
               'units': 'km'},
    'goes10': {'set': 'GOES10_EPHEMERIS_SSC',
               'var': 'XYZ_GSM',
               'time': 'Epoch',
               'coord': 'GSM',
               'units': 're'},
    'goes11': {'set': 'GOES11_EPHEMERIS_SSC',
               'var': 'XYZ_GSM',
               'time': 'Epoch',
               'coord': 'GSM',
               'units': 're'},
    'goes12': {'set': 'GOES12_EPHEMERIS_SSC',
               'var': 'XYZ_GSM',
               'time': 'Epoch',
               'coord': 'GSM',
               'units': 're'},
    'goes13': {'set': 'GOES13_EPHEMERIS_SSC',
               'var': 'XYZ_GSM',
               'time': 'Epoch',
               'coord': 'GSM',
               'units': 're'},
    'goes14': {'set': 'GOES14_EPHEMERIS_SSC',
               'var': 'XYZ_GSM',
               'time': 'Epoch',
               'coord': 'GSM',
               'units': 're'},
    'goes15': {'set': 'GOES15_EPHEMERIS_SSC',
               'var': 'XYZ_GSM',
               'time': 'Epoch',
               'coord': 'GSM',
               'units': 're'},
    'goes16': {'set': 'GOES16_EPHEMERIS_SSC',
               'var': 'XYZ_GSM',
               'time': 'Epoch',
               'coord': 'GSM',
               'units': 're'},
    'goes17': {'set': 'GOES17_EPHEMERIS_SSC', 'var': 'XYZ_GSM',
               ...
               'coord': 'GSM',
               'units': 're'},
    'goes18': {'set': 'GOES18_EPHEMERIS_SSC', 'var': 'XYZ_GSM',
               'time': 'Epoch',
               'coord': 'GSM',
               'units': 're'},
    'geotail': {'set': 'GE_OR_DEF',
                'var': 'GSM_POS',
                'time': 'Epoch',
                'coord': 'GSM',
                'units': 'km'},
    'themisa': {'set': 'THA_L1_STATE',
                'var': 'tha_pos_gsm',
                'time': 'tha_state_epoch',
                'coord': 'GSM',
                'units': 'km'},
    'themisb': {'set': 'THB_L1_STATE',
                'var': 'thb_pos_gsm',
                'time': 'thb_state_epoch',
                'coord': 'GSM',
                'units': 'km'},
    'themisc': {'set': 'THC_L1_STATE',
                'var': 'thc_pos_gsm',
                'time': 'thc_state_epoch',
                'coord': 'GSM',
                'units': 'km'},
    'themisd': {'set': 'THD_L1_STATE',
                'var': 'thd_pos_gsm',
                'time': 'thd_state_epoch',
                'coord': 'GSM',
                'units': 'km'},
    'themise': {'set': 'THE_L1_STATE',
                'var': 'the_pos_gsm',
                'time': 'the_state_epoch',
                'coord': 'GSM',
                'units': 'km'},
    'rbspa': {'set': 'RBSPA_L2-1MIN_PSBR-RPS',
              'var': 'Position',
              'time': 'Epoch',
              'coord': 'GEO',
              'units': 'km'},
    'rbspb': {'set': 'RBSPB_L2-1MIN_PSBR-RPS',
              'var': 'Position',
              'time': 'Epoch',
              'coord': 'GEO',
              'units': 'km'},
    'mms1': {'set': 'MMS1_MEC_SRVY_L2_EPHT89D',
              'var': 'mms1_mec_r_gsm',
              'time': 'Epoch',
              'coord': 'GSM',
              'units': 'km'},
    'mms2': {'set': 'MMS2_MEC_SRVY_L2_EPHT89D',
              'var': 'mms2_mec_r_gsm',
              'time': 'Epoch',
              'coord': 'GSM',
              'units': 'km'},
    'mms3': {'set': 'MMS3_MEC_SRVY_L2_EPHT89D',
              'var': 'mms3_mec_r_gsm',
              'time': 'Epoch',
              'coord': 'GSM',
              'units': 'km'},
    'mms4': {'set': 'MMS4_MEC_SRVY_L2_EPHT89D',
              'var': 'mms4_mec_r_gsm',
              'time': 'Epoch',
              'coord': 'GSM',
              'units': 'km'}
...
for s in sats_now:
    ...
    if args.verbose:
        print('\tConverting to SWMF input file...')
    out = SatOrbit()
    ...
    if out.attrs['coor'] == 'SM':
        out.attrs['coor'] = 'SMG'
    tnow = dt.datetime.now()
    out.attrs['head'] = ['Created with swmf_orbit_fetch.py on ' +
                         f'{tnow:%Y-%m-%d %H:%M%S}']
...
print(f'Finished. Found {len(orbits)} of ' +
      f'{len(sats_now)} requested spacecraft.')
